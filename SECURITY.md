...
If you discover a security vulnerability in muharrir, please report it
...
This policy covers the `muharrir` crate and its published API. Vulnerabilities
in dependencies should be reported to the respective upstream projects (and
flagged here if they affect muharrir users).
